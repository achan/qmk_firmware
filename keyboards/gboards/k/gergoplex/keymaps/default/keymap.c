...
[SYMB] = LAYOUT_gergoplex(
    KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_CIRC,      KC_AMPR, KC_ASTR, KC_TILD, KC_MINS, KC_BSLS,
    KC_LBRC, KC_RBRC, KC_LPRN, KC_RPRN, KC_TRNS,      KC_PLUS, KC_MINS, KC_SLSH, KC_ASTR, KC_QUOT,
